...
│   │   ├── 02_📝_Onboarding.py
│   │   ├── 03_📊_Dashboard.py
│   │   ├── 04_🛡️_My_Coverage.py
│   │   ├── 05_💰_Claims.py
│   │   └── 06_⚙️_Admin.py
│   ├── components/
│   │   ├── zone_selector.py     # Map-based zone selection
│   │   ├── premium_calculator.py # Dynamic pricing display
│   │   ├── claim_tracker.py     # Claim status visualization
│   │   └── risk_gauge.py        # Risk score display
│   ├── services/
│   │   ├── pricing_engine.py    # Premium calculation logic
│   │   ├── risk_assessor.py     # AI risk scoring
│   │   ├── claim_processor.py   # Automated claims
│   │   └── fraud_detector.py    # Fraud detection rules
│   ├── integrations/
│   │   ├── weather_api.py       # Weather data client
│   │   ├── maps_api.py          # Geolocation services
...
│   └── zone_risk_data.json     # Risk scores by zone
├── requirements.txt
└── README.md                    # This file
